...
<br>This guide is tailored to Arch Linux running GroovyArcade but you can still use these files when compiling in other distros (Windows e.g).
<br>Just check paths below and replace these files in your build folder.
<br>
<br>
